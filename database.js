...
const useCases = {
    gaming: { icon: '🎮', weights: { cpu: 10, gpu: 10, ram: 8, brightness: 9, oled: 6, capacity: 8, fast_charge: 7, audio_score: 6 } },
    photo: { icon: '📸', weights: { photo_score: 10, ois: 9, zoom: 7, color: 8, software_efficiency: 7 } },
    video: { icon: '🎬', weights: { video_score: 10, ois: 10, eis: 9, pro_video: 8, audio_score: 8, color: 7, capacity: 7 } },
    ...
    travel: { icon: '✈️', weights: { capacity: 10, precision_gps: 9, photo_score: 8, data5g: 7, drop_resistance: 6, material_score: 5, fast_charge: 6 } },
