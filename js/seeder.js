...
async function seedDatabase() {
    ...
    try {
        console.log('✅ Conexión a la base de datos remota establecida.');
        ...
        for (const phone of smartphones) {
            ...
            const batteryId = await getOrInsert(client, 'batteries', { capacity: d.battery.capacity, fast_charge: d.battery.fast_charge, energy_consumption: d.battery.energy_concumption || d.battery.energy_consumption || 0, has_wireless_charge: d.battery.wireless_charge }, ['capacity', 'fast_charge']);
